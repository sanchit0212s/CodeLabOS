    ...
    modules: [
      {
        ...
        lessons: [
          { n: 25, slug: "what-is-version-control", title: "What version control is and why it exists" },
          { n: 26, slug: "what-git-is", title: "What Git is — repositories, commits, history" },
          { n: 27, slug: "first-repo", title: "git init, git add, git commit — your first repo" },
          { n: 28, slug: "reading-git-log", title: "Reading git log and understanding commit history" },
          { n: 29, slug: "what-branches-are", title: "What branches are and why developers use them" },
          { n: 30, slug: "branching-workflow", title: "git branch, git checkout, git merge" },
          { n: 31, slug: "merge-conflicts", title: "Merge conflicts and how to resolve them" },
          { n: 32, slug: "gitignore", title: ".gitignore — what to never commit and why" },
        ],
      },
      {
        id: "1-2",
