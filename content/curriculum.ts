  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    modules: [
      ...
      },
      {
        ...
        lessons: [
          { n: 33, slug: "github-vs-git", title: "What GitHub is vs. what Git is", authored: true },
          { n: 34, slug: "push-pull-clone", title: "git push, git pull, git clone", authored: true },
          { n: 35, slug: "what-a-pr-is", title: "What a Pull Request is and how code review works", authored: true },
          { n: 36, slug: "reading-a-pr", title: "Reading a real PR — what to look for as an orchestrator", authored: true },
          { n: 37, slug: "github-actions-concept", title: "GitHub Actions — what CI/CD is at a conceptual level", authored: true },
        ],
      },
    ],
  },
